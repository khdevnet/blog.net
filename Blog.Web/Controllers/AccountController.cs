...
{
    [Authorize]
    public partial class AccountController : LayoutController
    {
        public AccountController(IServices services) : base(services) { }


        public AccountController(ApplicationUserService userManager, ApplicationSignInManager signInManager, IServices services)
            : base(services)
        {
        ...
        public ApplicationUserService UserManager
        {
            get
            {
                return _userManager ?? HttpContext.GetOwinContext().GetUserManager<ApplicationUserService>();
            }
            private set
            {
                _userManager = value;
